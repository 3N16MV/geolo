...
This exercise was conducted as an assignment for Cybersecurity Class
CYB333-25957 at National University. This program takes the search 
...
You can find a copy of the original code used for the exercise at 
http:www.py4e.com/code3/geojson.py.

Note: Google's geocoding service is free but has a limited rate, so you can not
make unlimited use of the API in a commercial application. Be respectful When
using a free API like Google's geocoding API. If too many
